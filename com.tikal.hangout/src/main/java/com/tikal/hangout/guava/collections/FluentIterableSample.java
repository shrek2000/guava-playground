...
public class FluentIterableSample {
	...
	public static void main(String[] args) {
		ImmutableList<String> cities = of("Tel Aviv", "Jerusalem","New York", "Paris","Bagdad");
		String result = from(cities).filter(city -> city.contains("e")).transform(city -> "'"+city + "'").limit(2).join(on(" "));
